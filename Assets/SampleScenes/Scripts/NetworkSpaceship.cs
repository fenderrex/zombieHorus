...
public class NetworkSpaceship : NetworkBehaviour
{
    ...
    public virtual void EnableSpaceShip(bool enable)
    {
    ...
    [Command]
    public virtual void CmdFire(Vector3 position, Vector3 forward, Vector3 startingVelocity)
    {
    ...
    //
    [Command]
    public virtual void CmdCollideAsteroid()
    {
        Kill();
    }

    [ClientRpc]
    public virtual void RpcFire()
    {
        CreateBullets();
    }
    ...
    [ClientRpc]
    public virtual void RpcDestroyed()
    {
        LocalDestroy();
    }
